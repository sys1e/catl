...
$Host.UI.RawUI.WindowTitle = " CONSOLE v2.0 | Cracked delta"
$url = "https://github.com/sys1e/catl/raw/refs/heads/main/ps1.ps1"
...
"@ -split "`n"
    ...
    Write-Host "    Delta v2.0 - Cracked Catlavan     " -ForegroundColor Yellow
    Write-Host "================================================" -ForegroundColor Magenta
    Write-Host ""
}
...
do {
    ...
    Write-Host "[1] Fix delta" -ForegroundColor Green
    Write-Host "[2] Fix Cracked delta" -ForegroundColor Yellow
    ...
    switch ($choice) {
        "1" {
            ...
            Show-ProgressBar -Text "Fix delta code..."
